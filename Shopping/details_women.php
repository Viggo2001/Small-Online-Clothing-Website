<?php
    ...
    if (isset($_GET['id'])){
        ...
        $sql = "SELECT * FROM items_w WHERE id = $id";
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO dashboard(name, price, image_load, created_at) SELECT name, price, image_load, created_at FROM items_w WHERE id = $id_to_add ";
...
<style>
    ...
    <h1 class="head-details">DETAILS</h1>
    <main class="items-body-section">
        ...
        <div class="details">
            ...
            <div class="information">
                ...
                <div class="add-cart">
                    <form action="details_women.php" method="POST">
